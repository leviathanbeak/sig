...
pub const MerkleNode = extern struct {
    ...
    // traversal).
    payload_buf: [32 * api.data_payload_max]u8,
...
pub fn insertFecSet(
    ...
    deshredded_node: *const api.DeshreddedFecSet,
    forest: *MerkleForest,
